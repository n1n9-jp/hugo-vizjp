...
title = "Examples of Alluvial Diagrams"
slug = "alluvial-diagrams-example"
date = "2020-08-03"
description = "This article collects examples related to Examples of Alluvial Diagrams. It is useful for comparing how the same visualization idea changes across..."
categories = [
    "chart",
]
tags = [
...
This article collects examples related to Examples of Alluvial Diagrams. It is useful for comparing how the same visualization idea changes across topics, datasets, and publication contexts.
