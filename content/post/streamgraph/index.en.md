...
slug = "streamgraph"
date = "2020-07-07"
description = "A streamgraph is a flowing variation of a stacked area chart used to show changing composition over time."
categories = [
    "chart",
]
tags = [
...
A streamgraph is a flowing variation of a stacked area chart used to show changing composition over time.
...
Streamgraph is useful when its structure fits the data and the reading task. As with any visualization method, the key is to make the encoding explicit and avoid asking the form to do more than it can support.
