...
title = "Chart Catalogues by Task"
slug = "chart-catalogue-by-tasks"
date = "2020-08-28"
description = "This article collects examples related to Chart Catalogues by Task. It is useful for comparing how the same visualization idea changes across topic..."
categories = [
    "chart",
]
tags = [
...
This article collects examples related to Chart Catalogues by Task. It is useful for comparing how the same visualization idea changes across topics, datasets, and publication contexts.
