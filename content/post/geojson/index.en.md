...
slug = "geojson"
date = "2020-03-12"
description = "This article introduces What Is GeoJSON? from a practical data visualization workflow perspective."
categories = [
    "technology",
]
tags = [
...
This article introduces What Is GeoJSON? from a practical data visualization workflow perspective.
...
What Is GeoJSON? is relevant as part of the broader craft of preparing, transforming, and publishing data. The value comes from understanding both the technical mechanism and the communication task it supports.
