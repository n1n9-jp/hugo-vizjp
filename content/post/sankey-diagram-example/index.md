...
サンキー・ダイアグラム（Sankey Diagram）の事例を紹介します。
...
![Source: Riedler, A. 1911. Wissenschaftliche Automobil-Wertung. Mario Schmidt. 2008. The Sankey Diagram in Energy and Material Flow Management.](images/image-1.png)



### セメント製造における理論的な熱消費量（左）と実用的な熱消費量（右）

![Source: Schott, E. 1933. Waermewirtschaft in der Zementindustrie. Mario Schmidt. 2008. The Sankey Diagram in Energy and Material Flow Management.](images/image-2.png)
