...
date = "2020-03-07"
description = "This article introduces Stevens' Power Law, explaining what the method shows, how to read it, and what design decisions matter."
categories = [
    "technology",
]
tags = [
...
This article introduces Stevens' Power Law, explaining what the method shows, how to read it, and what design decisions matter.
...
Stevens' Power Law is useful when its structure fits the data and the reading task. As with any visualization method, the key is to make the encoding explicit and avoid asking the form to do more than it can support.
