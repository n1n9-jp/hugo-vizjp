...
title = "Euler Diagrams and Venn Diagrams"
slug = "euler-venn-diagram"
date = "2020-08-03"
description = "Euler diagrams and Venn diagrams both use closed shapes to show relationships between sets, but they differ in how strictly all possible overlaps a..."
categories = [
    "consume",
]
tags = [
...
Euler diagrams and Venn diagrams both use closed shapes to show relationships between sets, but they differ in how strictly all possible overlaps are represented.
...
Euler Diagrams and Venn Diagrams is useful when its structure fits the data and the reading task. As with any visualization method, the key is to make the encoding explicit and avoid asking the form to do more than it can support.
