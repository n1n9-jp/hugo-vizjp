...
slug = "slopegraph"
date = "2020-08-03"
description = "A slopegraph connects values at two or more points to emphasize rank changes, increases, and decreases."
categories = [
    "chart",
]
tags = [
...
A slopegraph connects values at two or more points to emphasize rank changes, increases, and decreases.
...
Slopegraph is useful when its structure fits the data and the reading task. As with any visualization method, the key is to make the encoding explicit and avoid asking the form to do more than it can support.
