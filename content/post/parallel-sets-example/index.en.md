...
title = "Examples of Parallel Sets"
slug = "parallel-sets-example"
date = "2020-08-02"
description = "This article collects examples related to Examples of Parallel Sets. It is useful for comparing how the same visualization idea changes across topi..."
categories = [
    "chart",
]
tags = [
...
This article collects examples related to Examples of Parallel Sets. It is useful for comparing how the same visualization idea changes across topics, datasets, and publication contexts.
