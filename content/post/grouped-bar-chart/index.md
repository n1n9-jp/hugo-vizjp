...
グループ棒グラフ（Grouped Bar Chart）は、**複数のデータ系列をカテゴリごとに横に並べて比較する棒グラフの一種**です。同一カテゴリ内で複数のサブグループの値を隣接して配置することで、カテゴリ間の比較とサブグループ間の比較を同時に行うことができます。
