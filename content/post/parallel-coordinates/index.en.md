...
date = "2020-07-07"
description = "Parallel coordinates show multivariate data by drawing each observation as a polyline crossing a set of parallel axes."
categories = [
    "chart",
]
tags = [
...
Parallel coordinates show multivariate data by drawing each observation as a polyline crossing a set of parallel axes.
...
Parallel Coordinates is useful when its structure fits the data and the reading task. As with any visualization method, the key is to make the encoding explicit and avoid asking the form to do more than it can support.
