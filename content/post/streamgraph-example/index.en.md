...
title = "Examples of Streamgraphs"
slug = "streamgraph-example"
date = "2020-07-07"
description = "This article collects examples related to Examples of Streamgraphs. It is useful for comparing how the same visualization idea changes across topic..."
categories = [
    "chart",
]
tags = [
...
This article collects examples related to Examples of Streamgraphs. It is useful for comparing how the same visualization idea changes across topics, datasets, and publication contexts.
