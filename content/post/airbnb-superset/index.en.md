...
title = "Apache Superset, the Open Source BI Tool Developed at Airbnb"
slug = "airbnb-superset"
date = "2020-05-19"
description = "This article introduces Apache Superset, the Open Source BI Tool Developed at Airbnb from a practical data visualization workflow perspective."
categories = [
    "technology",
]
tags = [
...
This article introduces Apache Superset, the Open Source BI Tool Developed at Airbnb from a practical data visualization workflow perspective.
...
Apache Superset, the Open Source BI Tool Developed at Airbnb is relevant as part of the broader craft of preparing, transforming, and publishing data. The value comes from understanding both the technical mechanism and the communication task it supports.
