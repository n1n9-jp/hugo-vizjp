...
title = "D3: Data Formats and Requests"
slug = "d3-requests"
date = "2013-09-22"
description = "This article introduces D3: Data Formats and Requests from a practical data visualization workflow perspective."
categories = [
    "technology",
]
tags = [
...
This article introduces D3: Data Formats and Requests from a practical data visualization workflow perspective.
...
D3: Data Formats and Requests is relevant as part of the broader craft of preparing, transforming, and publishing data. The value comes from understanding both the technical mechanism and the communication task it supports.
