...
イールド・カーブ（Yield Curve）とは、国債などの**異なる満期（期間）の利回りを結んだ曲線**のことを指します。通常、横軸に「満期（年数）」、縦軸に「利回り（%）」をとり、短期から長期までの金利の関係を視覚的に示すチャートです。金融市場の期待と経済の先行きを読み解く重要な指標として、投資家やエコノミストに広く参照されています。
