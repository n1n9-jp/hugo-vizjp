...
レーダー・チャート（Radar Chart）は、多次元データを視覚的に比較するためのチャートで、複数の変数を放射状に配置し、それぞれの値を線や面で結んで多角形として表現します。特に、個人や製品、組織などの複数の属性や能力を比較するときに有効です。軸が放射状に広がることで、複雑な関係性を一目で把握できる点が特徴です。
